    ...
    <main className="flex flex-col items-center justify-between p-4 sm:p-6 md:p-8 overflow-hidden mx-auto">
      <div className="flex w-full max-w-[1080px] flex-col space-y-6">
          <div className="flex flex-col items-center">
            ...
            />
            <Image
              src="/images/month3.svg"
              alt="Stuff"
              width={200}
              height={100}
              className="cursor-pointer"
              onClick={() => router.push("/Stuff/M03")}    
            />
            <Image
              src="/images/Month2.svg"
              alt="Stuff"
              width={200}
              height={100}
              className="cursor-pointer"
              onClick={() => router.push("/Stuff/M02")}    
            />
            <Image
              src="/images/Month1.svg"
              alt="Stuff"
              width={200}
              height={100}
              className="cursor-pointer"
              onClick={() => router.push("/Stuff/M01")}    
            />
            <Image
              src="/images/Week24_Logo.svg"
              alt="Stuff"
              width={200}
              height={100}
              className="cursor-pointer"
              onClick={() => router.push("/Stuff/W24")}    
            />
            <Image
              src="/images/Week23_Logo.svg"
              alt="Stuff"
              width={200}
              height={100}
              className="cursor-pointer"
              onClick={() => router.push("/Stuff/W23")}    
            />
            <Image
              src="/images/Week22_Logo.svg"
              alt="Stuff"
              width={200}
              height={100}
              className="cursor-pointer"
              onClick={() => router.push("/Stuff/W22")}
            />
            <Image
