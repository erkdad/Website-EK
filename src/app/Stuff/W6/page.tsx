...
export default function W6() {
  return (
    <main className="flex w-full">
      ...
      <p> <img src="/images/W6/DSCF7238 (1).jpg" alt="Description of Image6"></img></p>
      <p> <img src="/images/W6/DSCF7236 (1).jpg" alt="Description of Image6"></img></p>
      ...
      <p> <img src="/images/W6/Thorbury.jpg" alt="Description of Image6"></img></p>
       <p className="text-xl leading-relaxed"> I even got my substack feed rolling in good
        ...
        <p className="text-xl leading-relaxed"> 06.26.2025 EK . Stayin curious!
        </p>
      </div>
    </main>
  );
